Els conjunts de dades `bus.csv`,` flights.csv`, `gz_2010_us_050_00_20m.json` i `unemployment.json` pertanyen als exemples de la biblioteca [geoplotlib](https://github.com/andrea-cuttone/ geoplotlib).
